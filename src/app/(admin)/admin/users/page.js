...
import MemberFetcher from "@/components/admin/fetchers/MemberFetcher";
import MemberSkeleton from "@/components/admin/skeletons/MemberSkeleton";
    ...
    <div dir="rtl">
      <main className="flex-grow p-4 sm:p-6 lg:p-10 xl:p-16 max-w-7xl mx-auto">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#45464d] mb-3">
          ...
          <ChevronLeft size={14} />
          <span className="text-[#0b1c30] font-bold">الأعضاء</span>
        </nav>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
          <div>
            ...
            <p className="text-[#45464d] mt-2 text-base lg:text-lg">
              قائمة بجميع الأعضاء المسجلين في المتجر.
            </p>
          </div>
        </div>
