    ...
    <footer className="bg-primary-container dark:bg-primary-container text-on-primary-container dark:text-on-tertiary-container w-full py-section-gap mt-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-gutter max-w-container-max mx-auto">
        <div className="flex flex-col gap-4">
          ...
          <p className="font-body-sm text-body-sm text-on-primary-container/80 max-w-full sm:max-w-xs">
            إهداء فاخر بدقة. نرتقي بفن تقديم العطور الفاخرة والمجموعات المنسقة.
          </p>
          <div className="flex gap-4 mt-2">
            <a className="text-on-primary-container/80 hover:text-secondary-fixed transition-colors" href="#" aria-label="فيسبوك">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a className="text-on-primary-container/80 hover:text-secondary-fixed transition-colors" href="#" aria-label="إكس">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a className="text-on-primary-container/80 hover:text-secondary-fixed transition-colors" href="#" aria-label="واتساب">
            ...
            <a className="text-on-primary-container/80 hover:text-secondary-fixed transition-colors" href="#" aria-label="انستغرام">
      ...
      <div className="border-t border-on-primary-container/20 mt-12 pt-8 text-center">
          <p className="font-body-sm text-body-sm text-on-primary-container/60">
            © 2024 {APP_CONFIG.siteName}. جميع الحقوق محفوظة. إهداء فاخر بدقة.
          </p>
      </div>
    </footer>
  );
